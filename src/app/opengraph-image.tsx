    ...
    (
      ...
      >
        ...
        <h1 style={{ color: "#fff", fontSize: 64, fontWeight: 800, lineHeight: 1.1, margin: "0 0 24px 0", maxWidth: 800 }}>
          Professional SEO{" "}
          <span style={{ color: "#d4a017" }}>Services</span>
        </h1>

        {/* Subtitle */}
        <p style={{ color: "#999", fontSize: 28, margin: "0 0 48px 0", maxWidth: 700 }}>
          Technical SEO, Content Strategy, Link Building for DACH businesses.
        </p>

        {/* Stats */}
        <div style={{ display: "flex", gap: "40px" }}>
          {[["200+", "Clients"], ["340%", "Traffic Growth"], ["4.9/5", "Rating"]].map(([val, label]) => (
