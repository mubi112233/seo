...
export async function ToolsIntegration({ lang }: { lang: string }) {
  const isGe = lang === "ge";
    ...
    >
      <div className={`container mx-auto ${SPACING.container}`}>
        ...
        <div className="max-w-6xl mx-auto">
          {/* Tools grid */}
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 mb-8 sm:mb-10 md:mb-12">
          ...
          {/* Callout */}
          <div className="bg-card rounded-lg sm:rounded-xl p-5 sm:p-6 md:p-8 text-center">
